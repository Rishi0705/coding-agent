# 🐶 How to Use Coco Codes in cerebras most effective 

### 1. First Startup & The "Enter" Quirk
After installation, run `coco-codes` in your terminal.
...
### 3. Restart
**Close and restart** Coco Codes. This ensures all configurations and pinned models are loaded correctly.
...
For that use coco-codes to implement. Use python-reviewer to verify the implementation. If there are errors give the feedback to coco_codes to fix. Repeat until the reviewer has no more "urgent" fixes, maximum 3 times.
