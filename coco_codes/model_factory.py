...
from coco_codes.gemini_model import GeminiModel
...
def _load_plugin_model_providers():
    ...
    try:
        from coco_codes.callbacks import on_register_model_providers
...
class ModelFactory:
    ...
    def load_config() -> Dict[str, Any]:
        ...
        try:
            from coco_codes.callbacks import on_load_models_config
    ...
    def get_model(model_name: str, config: Dict[str, Any]) -> Any:
        ...
        # via the register_model_type callback. See plugins/claude_code_oauth/register_callbacks.py
            ...
            headers["X-Cerebras-3rd-Party-Integration"] = "coco-codes"
            ...
            try:
                ...
                try:
                    ...
                    from coco_codes.plugins.gemini_oauth.config import (
                        GEMINI_OAUTH_CONFIG,
                    )
                    from coco_codes.plugins.gemini_oauth.utils import (
                        get_project_id,
                        get_valid_access_token,
                    )
            ...
            from coco_codes.gemini_code_assist import GeminiCodeAssistModel
