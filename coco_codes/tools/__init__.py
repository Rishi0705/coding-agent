from coco_codes.callbacks import on_register_tools
from coco_codes.messaging import emit_warning
from coco_codes.tools.agent_tools import register_invoke_agent, register_list_agents
from coco_codes.tools.ask_user_question import register_ask_user_question
...
from coco_codes.tools.browser.browser_workflows import (
...
from coco_codes.tools.display import (
...
from coco_codes.tools.image_tools import register_load_image
from coco_codes.tools.skills_tools import (
    register_activate_skill,
    register_list_or_search_skills,
)
from coco_codes.tools.universal_constructor import register_universal_constructor
...
def has_extended_thinking_active(model_name: str | None = None) -> bool:
    ...
    Returns:
        ...
        "enabled" or "adaptive".
    """
    from coco_codes.config import get_effective_model_settings, get_global_model_name
...
def register_tools_for_agent(
    ...
    """
    from coco_codes.config import get_universal_constructor_enabled
...
def _register_uc_tool_wrapper(agent, uc_tool_name: str):
    ...
    try:
        from coco_codes.plugins.universal_constructor.registry import get_registry
