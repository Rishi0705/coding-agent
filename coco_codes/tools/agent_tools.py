...
from coco_codes.tools.subagent_context import subagent_context
...
def register_list_agents(agent):
    ...
    def list_agents(context: RunContext) -> ListAgentsOutput:
        ...
        from coco_codes.config import get_banner_color

        list_agents_color = get_banner_color("list_agents")

        try:
            from coco_codes.agents import get_agent_descriptions, get_available_agents
...
def register_invoke_agent(agent):
    ...
    async def invoke_agent(
        ...
        """
        from coco_codes.agents.agent_manager import load_agent
        ...
        from coco_codes.agents.subagent_stream_handler import subagent_stream_handler
        ...
        try:
            ...
            from coco_codes.agents._builder import autostart_bound_servers_async
            from coco_codes.config import get_value
