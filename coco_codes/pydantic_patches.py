...
def _get_coco_codes_version() -> str:
    """Get the current coco-codes version."""
    try:
        return importlib.metadata.version("coco-codes")
    except Exception:
        return "0.0.0-dev"
...
def patch_user_agent() -> None:
    ...
    try:
        ...
        def _get_dynamic_user_agent() -> str:
            ...
            try:
                from coco_codes.config import get_global_model_name
