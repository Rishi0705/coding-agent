...
from coco_codes.agents._builder import (
    build_pydantic_agent,
    reload_mcp_servers,
)
from coco_codes.agents._compaction import summarize
from coco_codes.agents._history import (
    estimate_context_overhead,
    estimate_tokens_for_message,
    hash_message,
)
from coco_codes.agents._runtime import run_with_mcp, should_retry_streaming
...
class BaseAgent(ABC):
    """Abstract base for all Coco Codes agents."""
