...
from coco_codes.agents import _history, _key_listeners
from coco_codes.agents._builder import build_pydantic_agent
from coco_codes.agents._run_signals import (
...
from coco_codes.keymap import cancel_agent_uses_signal
...
async def run_with_mcp(
    ...
    **kwargs: Any,
    ...
    def graceful_sigint_handler(_sig, _frame):
        from coco_codes.keymap import get_cancel_agent_display_name
