"""Azure AI Foundry Plugin callbacks for Coco Codes CLI.

This plugin enables Coco Codes to use Anthropic Claude models hosted on
...
def _create_azure_foundry_model(
    ...
    from coco_codes.claude_cache_client import patch_anthropic_client_messages
    from coco_codes.config import get_effective_model_settings
    from coco_codes.model_factory import CONTEXT_1M_BETA
    from coco_codes.provider_identity import (
