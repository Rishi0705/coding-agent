...
Integrates the hook engine with coco_codes's callback system.
"""
...
from coco_codes.hook_engine import EventData, HookEngine
...
async def on_startup_hook() -> None:
    """Startup callback — fires SessionStart hooks when coco_codes boots."""
    if not _hook_engine:
        return
