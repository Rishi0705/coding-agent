...
The Obsidian Agent adds a specialized Coco Codes agent for working with Obsidian vaults through the official `obsidian` CLI.
...
Switch to the agent from Coco Codes and ask for an Obsidian task. Include a vault name or vault-relative path when relevant.
