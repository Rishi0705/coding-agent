...
Supports:
- Global hooks: ~/.coco_codes/hooks.json
...
_GLOBAL_HOOKS_FILE = os.path.expanduser("~/.coco_codes/hooks.json")
...
def _load_global_hooks_config() -> Dict[str, Any]:
    """Load hooks from ~/.coco_codes/hooks.json."""
...
def save_global_hooks_config(hooks: Dict[str, Any]) -> Path:
    """Persist hooks config to ~/.coco_codes/hooks.json.
