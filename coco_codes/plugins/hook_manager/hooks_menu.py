...
from both global (~/.coco_codes/hooks.json) and project (.claude/settings.json) sources.
...
class HooksMenu:
    ...
    def _render_list(self) -> List:
        ...
        if not self.entries:
            ...
            lines.append(("", "\n"))
            lines.append((_C_DIM, "  or ~/.coco_codes/hooks.json (global)"))
            lines.append(("", "\n\n"))
