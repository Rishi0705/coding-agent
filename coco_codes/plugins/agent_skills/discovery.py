...
from coco_codes.plugins.agent_skills.config import get_skill_directories
...
def get_default_skill_directories() -> List[Path]:
    ...
    Returns:
        - ~/.coco_codes/skills (user skills)
        - ./.coco_codes/skills (project config skills)
        - ./skills (project skills)
    """
    return [
        Path.home() / ".coco_codes" / "skills",
        Path.cwd() / ".coco_codes" / "skills",
        Path.cwd() / "skills",
    ]
