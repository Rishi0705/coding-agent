...
from coco_codes.config import get_value, set_value
...
def get_skill_directories() -> List[str]:
    ...
    Returns:
        ...
        Default: ['~/.coco_codes/skills', './.coco_codes/skills', './skills']
    ...
    home_skills = str(Path.home() / ".coco_codes" / "skills")
    project_config_skills = str(Path.cwd() / ".coco_codes" / "skills")
