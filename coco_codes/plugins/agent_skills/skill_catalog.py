...
Historically, coco_codes used a local static catalog. We now source skills from
`remote_catalog.fetch_remote_catalog()` while keeping the same access patterns.

Public API:
    from coco_codes.plugins.agent_skills.skill_catalog import (
        SkillCatalog,
        SkillCatalogEntry,
...
from coco_codes.plugins.agent_skills.remote_catalog import fetch_remote_catalog
