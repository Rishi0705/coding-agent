...
from coco_codes.mcp_prompts.hook_creator import HOOK_CREATION_PROMPT
...
def _custom_help():
    ...
    return [
        ("create-hook", "Get help creating Coco Codes hooks"),
    ]
...
def _handle_custom_command(command: str, name: str):
    ...
    return "I need help creating a hook for Coco Codes. Here's the documentation above. Can you help me?"
