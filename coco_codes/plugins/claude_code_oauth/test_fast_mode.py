...
from coco_codes.plugins.claude_code_oauth.fast_mode import (
    FAST_MODE_BETA,
    FAST_SETTING_KEY,
...
class TestIsFastModeEnabledRealConfigRoundTrip:
    ...
    def test_real_roundtrip_with_claude_code_model(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("coco_codes.config.CONFIG_FILE", str(cfg))

        from coco_codes.config import set_model_setting
