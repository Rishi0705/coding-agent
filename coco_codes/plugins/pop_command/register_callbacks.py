...
def emit_error(message: Any) -> None:
    from coco_codes.messaging import emit_error as _emit_error

    _emit_error(message)


def emit_info(message: Any) -> None:
    from coco_codes.messaging import emit_info as _emit_info

    _emit_info(message)


def emit_success(message: Any) -> None:
    from coco_codes.messaging import emit_success as _emit_success

    _emit_success(message)


def emit_warning(message: Any) -> None:
    from coco_codes.messaging import emit_warning as _emit_warning
