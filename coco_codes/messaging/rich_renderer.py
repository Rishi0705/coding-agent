...
This module implements the presentation layer for Coco Codes's messaging system.
...
from coco_codes.config import get_subagent_verbose
...
class RichConsoleRenderer:
    ...
    def _render_skill_list(self, msg: SkillListMessage) -> None:
        ...
        if not msg.skills:
            ...
            self._console.print(
                "[dim]  Install skills in ~/.coco_codes/skills/[/dim]\n"
            )
            return
