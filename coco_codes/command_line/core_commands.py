"""Command handlers for Coco Codes - CORE commands.
...
from coco_codes.command_line.utils import make_directory_table
from coco_codes.config import finalize_autosave_session
from coco_codes.messaging import emit_error, emit_info
from coco_codes.tools.tools_content import tools_content
...
def handle_paste_command(command: str) -> bool:
    ...
    from coco_codes.messaging import emit_info, emit_success, emit_warning
...
def handle_model_command(command: str) -> bool:
    ...
    from coco_codes.messaging import emit_success, emit_warning
...
def handle_add_model_command(command: str) -> bool:
    ...
    from coco_codes.tools.command_runner import set_awaiting_user_input
...
def handle_mcp_command(command: str) -> bool:
    ...
    from coco_codes.command_line.mcp import MCPCommandHandler
