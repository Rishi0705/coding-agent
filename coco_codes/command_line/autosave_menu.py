...
from coco_codes.config import AUTOSAVE_DIR
from coco_codes.session_storage import list_sessions, load_session
...
def display_resumed_history(
    ...
    from coco_codes.config import get_banner_color, get_resume_message_count
