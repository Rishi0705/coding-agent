"""Command handlers for Coco Codes - SESSION commands.
...
from coco_codes.config import CONTEXTS_DIR
from coco_codes.session_storage import list_sessions, load_session, save_session
...
def handle_compact_command(command: str) -> bool:
    ...
    from coco_codes.config import get_compaction_strategy, get_protected_token_count
    ...
    try:
        ...
        if compaction_strategy == "truncation":
            from coco_codes.agents._compaction import truncate
