...
from coco_codes.command_line.command_registry import get_unique_commands
...
from coco_codes.command_line.mcp_completion import MCPCompleter
from coco_codes.command_line.model_picker_completion import (
    ModelNameCompleter,
    get_active_model,
)
from coco_codes.command_line.pin_command_completion import PinCompleter, UnpinCompleter
from coco_codes.command_line.skills_completion import SkillsCompleter
from coco_codes.command_line.utils import list_directory
...
class SlashCompleter(Completer):
    ...
    def get_completions(self, document, complete_event):
        ...
        try:
            from coco_codes import callbacks, plugins
...
def get_prompt_with_active_model(base: str = ">>> "):
    ...
    agent_display = current_agent.display_name if current_agent else "coco-codes"
...
async def get_input_with_combined_completion(
    ...
    from coco_codes.plugins.ollama_setup.completer import OllamaSetupCompleter
