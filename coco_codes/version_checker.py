"""Version checking utilities for Coco Codes."""

import httpx

from coco_codes.messaging import emit_info, emit_success, emit_warning, get_message_bus
from coco_codes.messaging.messages import VersionCheckMessage
...
def default_version_mismatch_behavior(current_version):
    ...
    latest_version = fetch_latest_version("coco-codes")
