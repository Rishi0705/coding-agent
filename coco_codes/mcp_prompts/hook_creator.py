...
before user prompts for creating Coco Codes hooks.
"""

HOOK_CREATION_PROMPT = """
# Creating Hooks in Coco Codes

You are helping a user create hooks for Coco Codes. Coco Codes has two hook systems:
...
Configure shell commands responding to Coco Codes events in `.claude/settings.json`:
