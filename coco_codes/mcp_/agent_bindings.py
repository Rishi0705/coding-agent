...
Storage: ``$XDG_CONFIG_HOME/coco_codes/mcp_agent_bindings.json``
...
* Strict opt-in: an agent with no entry gets *zero* MCP servers from
  :py:meth:`coco_codes.mcp_.MCPManager.get_servers_for_agent`.
...
from coco_codes.config import CONFIG_DIR
