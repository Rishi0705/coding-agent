from coding_agent.callbacks import on_register_tools
from coding_agent.messaging import emit_warning
from coding_agent.tools.agent_tools import register_invoke_agent, register_list_agents
from coding_agent.tools.ask_user_question import register_ask_user_question
...
from coding_agent.tools.browser.browser_workflows import (
...
from coding_agent.tools.display import (
...
from coding_agent.tools.image_tools import register_load_image
from coding_agent.tools.skills_tools import (
    register_activate_skill,
    register_list_or_search_skills,
)
from coding_agent.tools.universal_constructor import register_universal_constructor
...
def has_extended_thinking_active(model_name: str | None = None) -> bool:
    ...
    Returns:
        ...
        "enabled" or "adaptive".
    """
    from coding_agent.config import get_effective_model_settings, get_global_model_name
...
def register_tools_for_agent(
    ...
    """
    from coding_agent.config import get_universal_constructor_enabled
...
def _register_uc_tool_wrapper(agent, uc_tool_name: str):
    ...
    try:
        from coding_agent.plugins.universal_constructor.registry import get_registry
