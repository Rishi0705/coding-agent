...
```python
from coding_agent.tools.subagent_context import subagent_context, is_subagent
...
def subagent_context(agent_name: str) -> Generator[None, None, None]:
    ...
    Args:
        agent_name: Name of the sub-agent being executed (e.g., "retriever", "coding-agent")
