...
from coding_agent.tools.subagent_context import subagent_context
...
def register_list_agents(agent):
    ...
    def list_agents(context: RunContext) -> ListAgentsOutput:
        ...
        from coding_agent.config import get_banner_color

        list_agents_color = get_banner_color("list_agents")

        try:
            from coding_agent.agents import get_agent_descriptions, get_available_agents
...
def register_invoke_agent(agent):
    ...
    async def invoke_agent(
        ...
        """
        from coding_agent.agents.agent_manager import load_agent
        ...
        from coding_agent.agents.subagent_stream_handler import subagent_stream_handler
        ...
        try:
            ...
            # ``load_agent_rules`` lives on the builder module since the
            ...
            from coding_agent.agents._builder import autostart_bound_servers_async
            from coding_agent.config import get_value
