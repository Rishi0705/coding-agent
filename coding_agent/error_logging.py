"""Error logging utility for coding_agent.

Logs unexpected errors to XDG_STATE_HOME/coding_agent/logs/ for debugging purposes.
Per XDG spec, logs are "state data" (actions history), not configuration.
Error logging module for Coding Agent. 
"""
...
from coding_agent.config import STATE_DIR
