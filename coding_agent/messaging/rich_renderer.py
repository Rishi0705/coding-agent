...
This module implements the presentation layer for Coding Agent's messaging system.
...
from coding_agent.config import get_subagent_verbose
...
class RichConsoleRenderer:
    ...
    def _render_skill_list(self, msg: SkillListMessage) -> None:
        ...
        if not msg.skills:
            ...
            self._console.print(
                "[dim]  Install skills in ~/.coding_agent/skills/[/dim]\n"
            )
            return
