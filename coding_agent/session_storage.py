...
async def restore_autosave_interactively(base_dir: Path) -> None:
    ...
    from coding_agent.messaging import emit_success, emit_system_message, emit_warning
    ...
    try:
        from coding_agent.config import set_current_autosave_from_session_name
