"""Interactive TUI onboarding wizard for first-time Coding Agent users.
...
from coding_agent.config import CONFIG_DIR
...
def should_show_onboarding() -> bool:
    ...
    - CODING_AGENT_SKIP_TUTORIAL env var is set to '1' or 'true'
    """
    # Allow skipping tutorial via environment variable (useful for testing)
    skip_env = os.environ.get("CODING_AGENT_SKIP_TUTORIAL", "").lower()
...
async def run_onboarding_wizard() -> Optional[str]:
    ...
    try:
        ...
        root_container = Frame(slide_panel, title="Coding Agent Tutorial")
    ...
    if wizard.result == "skipped":
        ...
        emit_info("Tutorial completed! Welcome to Coding Agent! ")
    else:
