"""Command handlers for Coding Agent - SESSION commands.
...
from coding_agent.config import CONTEXTS_DIR
from coding_agent.session_storage import list_sessions, load_session, save_session
...
def handle_compact_command(command: str) -> bool:
    ...
    from coding_agent.config import get_compaction_strategy, get_protected_token_count
    ...
    try:
        ...
        if compaction_strategy == "truncation":
            from coding_agent.agents._compaction import truncate
