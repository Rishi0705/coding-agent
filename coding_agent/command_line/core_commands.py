"""Command handlers for Coding Agent - CORE commands.
...
from coding_agent.command_line.utils import make_directory_table
from coding_agent.config import finalize_autosave_session
from coding_agent.messaging import emit_error, emit_info
from coding_agent.tools.tools_content import tools_content
...
def handle_paste_command(command: str) -> bool:
    ...
    from coding_agent.messaging import emit_info, emit_success, emit_warning
...
def handle_tutorial_command(command: str) -> bool:
    ...
    from coding_agent.command_line.onboarding_wizard import (
        reset_onboarding,
...
def handle_model_command(command: str) -> bool:
    ...
    from coding_agent.messaging import emit_success, emit_warning
...
def handle_add_model_command(command: str) -> bool:
    ...
    from coding_agent.tools.command_runner import set_awaiting_user_input
...
def handle_mcp_command(command: str) -> bool:
    ...
    from coding_agent.command_line.mcp import MCPCommandHandler
