...
Launched from :mod:`coding_agent.command_line.agent_menu` (and reused by the
post-install flow in :mod:`coding_agent.command_line.mcp.install_command`).
...
from coding_agent.mcp_.agent_bindings import (
    get_bound_servers,
    is_bound,
    set_binding,
    toggle_auto_start,
...
async def prompt_bind_after_install(server_name: str) -> None:
    ...
    """
    from coding_agent.agents import get_available_agents
    from coding_agent.mcp_.agent_bindings import (
        get_auto_start,
        toggle_binding,
    )
