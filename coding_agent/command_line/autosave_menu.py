...
from coding_agent.config import AUTOSAVE_DIR
from coding_agent.session_storage import list_sessions, load_session
...
def display_resumed_history(
    ...
    from coding_agent.config import get_banner_color, get_resume_message_count
