...
def get_gradient_banner() -> str:
    """Generate the gradient CODING AGENT banner."""
    try:
        import pyfiglet

        lines = pyfiglet.figlet_format("CODING AGENT", font="ansi_shadow").split("\n")
        colors = ["bright_green"]
        result = []
        ...
        return "[bold bright_green]CODING AGENT [/bold bright_green]"
...
def slide_use_cases() -> str:
    ...
    content += "[bold bright_green]Coding Agent (default)[/bold bright_green]\n"
