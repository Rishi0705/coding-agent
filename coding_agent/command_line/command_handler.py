...
import coding_agent.command_line.config_commands  # noqa: F401
import coding_agent.command_line.core_commands  # noqa: F401
import coding_agent.command_line.session_commands  # noqa: F401
import coding_agent.command_line.uc_menu  # noqa: F401
...
def _ensure_plugins_loaded() -> None:
    ...
    if _PLUGINS_LOADED:
        return
    try:
        from coding_agent import plugins
...
def handle_command(command: str):
    ...
    from coding_agent.messaging import emit_info, emit_warning
