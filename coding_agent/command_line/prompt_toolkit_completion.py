...
from coding_agent.command_line.command_registry import get_unique_commands
...
from coding_agent.command_line.mcp_completion import MCPCompleter
from coding_agent.command_line.model_picker_completion import (
    ModelNameCompleter,
    get_active_model,
)
from coding_agent.command_line.pin_command_completion import PinCompleter, UnpinCompleter
from coding_agent.command_line.skills_completion import SkillsCompleter
from coding_agent.command_line.utils import list_directory
...
class SetCompleter(Completer):
    ...
    def get_completions(self, document, complete_event):
        ...
        for key in config_keys:
            if key == "model" or key == "auth_token":
                continue  # exclude 'model' and 'auth_token' from regular /set completions
...
class SlashCompleter(Completer):
    ...
    def get_completions(self, document, complete_event):
        ...
        try:
            from coding_agent import callbacks, plugins
...
def get_prompt_with_active_model(base: str = ">>> "):
    ...
    agent_display = current_agent.display_name if current_agent else "coding-agent"
...
async def get_input_with_combined_completion(
    ...
    from coding_agent.plugins.ollama_setup.completer import OllamaSetupCompleter
    ...
    style = Style.from_dict(
        {
            ...
            "assistant": "bold ansibrightgreen",
            "owner": "bold ansibrightgreen",
            "agent": "bold ansibrightgreen",
            "model": "bold ansibrightgreen",
            "cwd": "bold ansibrightgreen",
            "arrow": "bold ansibrightgreen",
            "attachment-placeholder": "italic ansigreen",
        }
    )
