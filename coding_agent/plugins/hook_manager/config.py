...
Supports:
- Global hooks: ~/.coding_agent/hooks.json
...
_GLOBAL_HOOKS_FILE = os.path.expanduser("~/.coding_agent/hooks.json")
...
def _load_global_hooks_config() -> Dict[str, Any]:
    """Load hooks from ~/.coding_agent/hooks.json."""
...
def save_global_hooks_config(hooks: Dict[str, Any]) -> Path:
    """Persist hooks config to ~/.coding_agent/hooks.json.
