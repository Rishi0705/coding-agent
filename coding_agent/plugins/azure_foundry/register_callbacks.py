"""Azure AI Foundry Plugin callbacks for Coding Agent CLI.

This plugin enables Coding Agent to use Anthropic Claude models hosted on
...
def _create_azure_foundry_model(
    ...
    from coding_agent.claude_cache_client import patch_anthropic_client_messages
    from coding_agent.config import get_effective_model_settings
    from coding_agent.model_factory import CONTEXT_1M_BETA
    from coding_agent.provider_identity import (
