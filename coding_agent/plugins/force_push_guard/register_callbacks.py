...
from coding_agent.plugins.force_push_guard.detector import detect_force_push
...
def _block_command(command: str, match: Any) -> Dict[str, Any]:
    ...
    error_message = (
        ...
        f"in your terminal (outside coco codes) after double-checking the target branch."
    )
