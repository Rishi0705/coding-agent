...
def handle_goal_command(command: str) -> str | bool:
    ...
    prompt = _extract_prompt(command)
    if not prompt:
        emit_warning("Usage: /goal <prompt>  (aliases: /task, /objective)")
...
def handle_judges_command(command: str) -> bool:
    ...
    from coding_agent.command_line.judges_menu import interactive_judges_menu
...
async def _run_single_judge(
    ...
    *,
    ...
    try:
        ...
        from coding_agent.error_logging import log_error
