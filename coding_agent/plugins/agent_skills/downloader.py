...
from coding_agent.plugins.agent_skills.discovery import refresh_skill_cache
from coding_agent.plugins.agent_skills.installer import InstallResult

logger = logging.getLogger(__name__)

_DEFAULT_SKILLS_DIR = Path.home() / ".coding_agent" / "skills"
...
def _download_to_file(url: str, dest: Path) -> bool:
    ...
    headers = {
        ...
        "User-Agent": "coding-agent/skill-downloader",
    }
...
def download_and_install_skill(
    ...
    Args:
        ...
        target_dir: Base skills directory. Defaults to ~/.coding_agent/skills.
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="coding_agent_skill_") as tmp:
            tmp_dir = Path(tmp)
