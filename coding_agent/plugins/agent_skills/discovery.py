...
from coding_agent.plugins.agent_skills.config import get_skill_directories
...
def get_default_skill_directories() -> List[Path]:
    ...
    Returns:
        - ~/.coding_agent/skills (user skills)
        - ./.coding_agent/skills (project config skills)
        - ./skills (project skills)
    """
    return [
        Path.home() / ".coding_agent" / "skills",
        Path.cwd() / ".coding_agent" / "skills",
        Path.cwd() / "skills",
    ]
