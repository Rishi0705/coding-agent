...
Historically, coding_agent used a local static catalog. We now source skills from
`remote_catalog.fetch_remote_catalog()` while keeping the same access patterns.

Public API:
    from coding_agent.plugins.agent_skills.skill_catalog import (
        SkillCatalog,
        SkillCatalogEntry,
...
from coding_agent.plugins.agent_skills.remote_catalog import fetch_remote_catalog
