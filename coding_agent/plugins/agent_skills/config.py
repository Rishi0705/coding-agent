...
from coding_agent.config import get_value, set_value
...
def get_skill_directories() -> List[str]:
    ...
    Returns:
        ...
        Reads from coco.cfg [coco] section under 'skill_directories' key.
        Default: ['~/.coding_agent/skills', './.coding_agent/skills', './skills']
    ...
    home_skills = str(Path.home() / ".coding_agent" / "skills")
    project_config_skills = str(Path.cwd() / ".coding_agent" / "skills")
