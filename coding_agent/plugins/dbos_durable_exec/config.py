...
from coding_agent.config import DATA_DIR, get_value, set_config_value
...
def is_enabled() -> bool:
    """Return True if 'enable_dbos' in coco.cfg is truthy. Default: True."""
...
def set_enabled(enabled: bool) -> None:
    """Persist the 'enable_dbos' switch to coco.cfg."""
