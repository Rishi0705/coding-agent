...
Integrates the hook engine with coding_agent's callback system.
"""
...
from coding_agent.hook_engine import EventData, HookEngine
...
async def on_startup_hook() -> None:
    """Startup callback — fires SessionStart hooks when coding_agent boots."""
    if not _hook_engine:
        return
