...
from coding_agent.plugins.claude_code_oauth.fast_mode import (
    FAST_MODE_BETA,
    FAST_SETTING_KEY,
...
class TestIsFastModeEnabledRealConfigRoundTrip:
    ...
    def test_real_roundtrip_with_claude_code_model(self, tmp_path, monkeypatch):
        ...
        cfg = tmp_path / "coco.cfg"
        monkeypatch.setattr("coding_agent.config.CONFIG_FILE", str(cfg))

        from coding_agent.config import set_model_setting
