"""
Claude Code OAuth Plugin for Coding Agent.
...
from ..oauth_html_templates import oauth_failure_html, oauth_success_html
...
def _await_callback(context: OAuthContext) -> Optional[str]:
    ...
    emit_info(
        ...
        "and paste it back into Coding Agent."
    )
...
def _create_claude_code_model(model_name: str, model_config: Dict, config: Dict) -> Any:
    ...
    from coding_agent.config import get_all_model_settings
