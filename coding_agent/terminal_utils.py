...
def print_truecolor_warning(console: Optional["Console"] = None) -> None:
    ...
    if console is None:
        try:
            ...
            print("=" * 70)
            print("Coding Agent looks best with truecolor support.")
    ...
    warning_lines = [
        ...
        "",
        "[bold white]Coding Agent uses rich colors and will look degraded without truecolor.[/]",
        "",
        "[bright_green]Consider using a modern terminal emulator:[/]",
        "  [bright_green]•[/] [bold]iTerm2[/] (macOS) - https://iterm2.com",
        "  [bright_green]•[/] [bold]Windows Terminal[/] (Windows) - Built into Windows 11",
        "  [bright_green]•[/] [bold]Kitty[/] - https://sw.kovidgoyal.net/kitty",
        "  [bright_green]•[/] [bold]Alacritty[/] - https://alacritty.org",
        "  [bright_green]•[/] [bold]Warp[/] (macOS) - https://warp.dev",
        "",
        "[bright_green]Or try setting the COLORTERM environment variable:[/]",
