...
before user prompts for creating Coding Agent hooks.
"""

HOOK_CREATION_PROMPT = """
# Creating Hooks in Coding Agent

You are helping a user create hooks for Coding Agent. Coding Agent has two hook systems:
...
Configure shell commands responding to Coding Agent events in `.claude/settings.json`:
