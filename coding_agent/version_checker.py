"""Version checking utilities for Coding Agent."""

import httpx

from coding_agent.messaging import emit_info, emit_success, emit_warning, get_message_bus
from coding_agent.messaging.messages import VersionCheckMessage
...
def default_version_mismatch_behavior(current_version):
    ...
    latest_version = fetch_latest_version("coding-agent")
    ...
    if update_available:
        ...
        emit_warning(f"A new version of coco codes is available: {latest_version}")
