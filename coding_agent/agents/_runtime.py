...
from coding_agent.agents import _history, _key_listeners
from coding_agent.agents._builder import build_pydantic_agent
from coding_agent.agents._run_signals import (
...
from coding_agent.keymap import cancel_agent_uses_signal
...
async def run_with_mcp(
    ...
    **kwargs: Any,
    ...
    def graceful_sigint_handler(_sig, _frame):
        from coding_agent.keymap import get_cancel_agent_display_name
