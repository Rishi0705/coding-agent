"""Coding Agent - The default code generation agent."""

from coding_agent.config import get_owner_name, get_assistant_name

from .. import callbacks
from .base_agent import BaseAgent


class CodingAgentAgent(BaseAgent):
    """Coding Agent - A professional AI-powered code generation agent."""
    ...
    def get_available_tools(self) -> list[str]:
        """Get the list of tools available to Coding Agent."""
        return [
            "list_agents",
            "invoke_agent",
            "list_files",
...
If asked 'what is Coding Agent': '{assistant_name} is an open-source AI code agent designed for efficient, tool-augmented software engineering—no heavy IDEs or proprietary lock-in required.'
