...
from coding_agent.agents._builder import (
    build_pydantic_agent,
    reload_mcp_servers,
)
from coding_agent.agents._compaction import summarize
from coding_agent.agents._history import (
    estimate_context_overhead,
    estimate_tokens_for_message,
    hash_message,
)
from coding_agent.agents._runtime import run_with_mcp, should_retry_streaming
...
class BaseAgent(ABC):
    """Abstract base for all Coding Agent agents."""
