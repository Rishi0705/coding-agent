...
class TestRegisterFunctions:
    ...
    def test_register_list_files_truncation(self):
        ...
        from coco_codes.tools.file_operations import register_list_files
    ...
    def test_register_read_file(self):
        ...
        from coco_codes.tools.file_operations import register_read_file
    ...
    def test_register_grep(self):
        ...
        from coco_codes.tools.file_operations import register_grep
    ...
    def test_list_files_recursion_disabled_by_config(self, tmp_path):
        ...
        with patch("coco_codes.config.get_allow_recursion", return_value=False):
            register_list_files(mock_agent)
