...
from coco_codes.tools.ask_user_question.theme import (
    RichColors,
    TUIColors,
...
class TestGetConfigValue:
    ...
    def test_import_error_returns_none(self):
        import coco_codes.tools.ask_user_question.theme as theme_mod

        # Reset cached getter
        old = theme_mod._config_getter
        theme_mod._config_getter = None
        try:
            with patch.dict("sys.modules", {"coco_codes.config": None}):
    ...
    def test_uses_config_get_value(self):
        ...
        try:
            ...
            with patch("coco_codes.tools.ask_user_question.theme._config_getter", None):
                with patch("coco_codes.config.get_value", mock_get):
                    theme_mod._config_getter = None
...
class TestApplyConfigOverrides:
    ...
    def test_no_overrides_returns_default(self):
        default = TUIColors()
        with patch(
            "coco_codes.tools.ask_user_question.theme._get_config_value",
            return_value=None,
        ):
