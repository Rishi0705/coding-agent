...
class TestAgentTools:
    ...
    def test_invoke_agent_imports_load_agent_rules_from_builder(self):
        """Regression: ``load_agent_rules`` is a free function in ``_builder``,
        ...
        assert not hasattr(BaseAgent, "load_agent_rules")

        # The free function is the canonical entry point.
        assert callable(_builder.load_agent_rules)
