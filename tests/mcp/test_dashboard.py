"""
Comprehensive tests for coding_agent/mcp_/dashboard.py
...
from coding_agent.mcp_.dashboard import MCPDashboard
from coding_agent.mcp_.status_tracker import ServerState
...
class TestRenderDashboard:
    ...
    @patch("coding_agent.mcp_.dashboard.get_mcp_manager")
