"""
Comprehensive tests for coco_codes/mcp_/dashboard.py
...
from coco_codes.mcp_.dashboard import MCPDashboard
from coco_codes.mcp_.status_tracker import ServerState
...
class TestRenderDashboard:
    ...
    @patch("coco_codes.mcp_.dashboard.get_mcp_manager")
