...
from coding_agent.mcp_.registry import ServerRegistry
...
class TestRegisterDuplicateId:
    ...
    def test_register_duplicate_id_raises_error(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch("coding_agent.mcp_.registry.config.DATA_DIR", tmpdir):
...
class TestLoadEdgeCases:
    ...
    def test_load_config_exception_during_parse(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "coding_agent.mcp_.registry.ServerConfig",
