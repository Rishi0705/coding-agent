...
class TestManagedMCPServerInit:
    ...
    def test_init_handles_create_server_error(self):
        ...
        with patch(
            "coco_codes.mcp_.managed_server.MCPServerSSE",
...
class TestCreateServerSSE:
    ...
    def test_sse_with_headers_creates_http_client(self):
        ...
        with (
            patch("coco_codes.mcp_.managed_server.MCPServerSSE") as mock_sse,
            patch(
                "coco_codes.mcp_.managed_server.create_async_client",
...
class TestCreateServerStdio:
    ...
    def test_stdio_with_string_args(self):
        ...
        with patch(
            "coco_codes.mcp_.managed_server.BlockingMCPServerStdio"
        ) as mock_stdio:
...
class TestGetHttpClient:
    ...
    def test_creates_client_with_expanded_headers(self):
        ...
        with (
            ...
            patch("coco_codes.mcp_.managed_server.MCPServerSSE") as mock_sse,
            patch("coco_codes.mcp_.managed_server.create_async_client") as mock_create,
        ):
            mock_sse.return_value = MagicMock()
