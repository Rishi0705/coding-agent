"""
Comprehensive tests for coco_codes/mcp_/config_wizard.py
...
from coco_codes.mcp_.config_wizard import (
    MCPConfigWizard,
    confirm_ask,
    prompt_ask,
    run_add_wizard,
)
from coco_codes.mcp_.managed_server import ServerConfig


class TestPromptAsk:
    """Tests for the prompt_ask helper function."""

    @patch("coco_codes.mcp_.config_wizard.emit_prompt")
    ...
    @patch("coco_codes.mcp_.config_wizard.emit_prompt")
    @patch("coco_codes.mcp_.config_wizard.emit_error")
...
class TestMCPConfigWizardInit:
    ...
    @patch("coco_codes.mcp_.config_wizard.get_mcp_manager")
...
class TestValidationMethods:
    ...
    def wizard(self):
        ...
        with patch("coco_codes.mcp_.config_wizard.get_mcp_manager"):
...
class TestPromptServerName:
    ...
    def wizard(self):
        ...
        with patch(
            "coco_codes.mcp_.config_wizard.get_mcp_manager", return_value=mock_manager
        ):
            return MCPConfigWizard()

    @patch("coco_codes.mcp_.config_wizard.prompt_ask")
    ...
    @patch("coco_codes.mcp_.config_wizard.prompt_ask")
    @patch("coco_codes.mcp_.config_wizard.confirm_ask")
    @patch("coco_codes.mcp_.config_wizard.emit_error")
...
class TestPromptServerType:
    ...
    @patch("coco_codes.mcp_.config_wizard.emit_info")
    @patch("coco_codes.mcp_.config_wizard.prompt_ask")
...
class TestPromptStdioConfig:
    ...
    @patch("coco_codes.mcp_.config_wizard.confirm_ask")
    @patch("coco_codes.mcp_.config_wizard.emit_info")
    @patch("coco_codes.mcp_.config_wizard.emit_warning")
...
class TestTestConnection:
    ...
    @patch("coco_codes.mcp_.config_wizard.emit_info")
    @patch("coco_codes.mcp_.config_wizard.emit_success")
...
class TestRunAddWizard:
    ...
    def test_run_add_wizard_success(
        ...
        with patch.object(MCPConfigWizard, "run_wizard", return_value=config):
            with patch("coco_codes.config.MCP_SERVERS_FILE", "/tmp/mcp_servers.json"):
