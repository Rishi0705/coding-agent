"""
Comprehensive tests for coding_agent/mcp_/config_wizard.py
...
from coding_agent.mcp_.config_wizard import (
    MCPConfigWizard,
    confirm_ask,
    prompt_ask,
    run_add_wizard,
)
from coding_agent.mcp_.managed_server import ServerConfig


class TestPromptAsk:
    """Tests for the prompt_ask helper function."""

    @patch("coding_agent.mcp_.config_wizard.emit_prompt")
    ...
    @patch("coding_agent.mcp_.config_wizard.emit_prompt")
    @patch("coding_agent.mcp_.config_wizard.emit_error")
...
class TestMCPConfigWizardInit:
    ...
    @patch("coding_agent.mcp_.config_wizard.get_mcp_manager")
...
class TestValidationMethods:
    ...
    def wizard(self):
        ...
        with patch("coding_agent.mcp_.config_wizard.get_mcp_manager"):
...
class TestPromptServerName:
    ...
    def wizard(self):
        ...
        with patch(
            "coding_agent.mcp_.config_wizard.get_mcp_manager", return_value=mock_manager
        ):
            return MCPConfigWizard()

    @patch("coding_agent.mcp_.config_wizard.prompt_ask")
    ...
    @patch("coding_agent.mcp_.config_wizard.prompt_ask")
    @patch("coding_agent.mcp_.config_wizard.confirm_ask")
    @patch("coding_agent.mcp_.config_wizard.emit_error")
...
class TestPromptServerType:
    ...
    @patch("coding_agent.mcp_.config_wizard.emit_info")
    @patch("coding_agent.mcp_.config_wizard.prompt_ask")
...
class TestPromptStdioConfig:
    ...
    @patch("coding_agent.mcp_.config_wizard.confirm_ask")
    @patch("coding_agent.mcp_.config_wizard.emit_info")
    @patch("coding_agent.mcp_.config_wizard.emit_warning")
...
class TestTestConnection:
    ...
    @patch("coding_agent.mcp_.config_wizard.emit_info")
    @patch("coding_agent.mcp_.config_wizard.emit_success")
...
class TestRunAddWizard:
    ...
    def test_run_add_wizard_success(
        ...
        with patch.object(MCPConfigWizard, "run_wizard", return_value=config):
            with patch("coding_agent.config.MCP_SERVERS_FILE", "/tmp/mcp_servers.json"):
