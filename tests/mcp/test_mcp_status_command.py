...
class TestStatusCommand:
    ...
    def test_execute_no_args_shows_list(self, mock_emit_info, mock_mcp_manager):
        ...
        command = StatusCommand()
        with patch(
            "coding_agent.command_line.mcp.status_command.ListCommand"
        ) as mock_list_cmd:
            mock_instance = Mock()
    ...
    def test_execute_server_not_found(self, mock_emit_info, mock_mcp_manager):
        ...
        with patch(
            ...
            with patch(
                "coding_agent.command_line.mcp.status_command.suggest_similar_servers"
            ) as mock_suggest:
    ...
    @patch("coding_agent.mcp_.async_lifecycle.get_lifecycle_manager")
    ...
    def test_show_detailed_server_status_exception_handling(self, mock_mcp_manager):
        ...
        with patch(
            "coding_agent.command_line.mcp.status_command.emit_error",
