...
from coding_agent.version_checker import (
...
class TestFetchLatestVersion:
    ...
    @patch("coding_agent.version_checker.httpx.get")
...
class TestDefaultVersionMismatchBehavior:
    ...
    @patch("coding_agent.version_checker.get_message_bus")
    @patch("coding_agent.version_checker.emit_success")
    @patch("coding_agent.version_checker.emit_warning")
    @patch("coding_agent.version_checker.emit_info")
    @patch("coding_agent.version_checker.fetch_latest_version")
