...
from coco_codes.version_checker import (
...
class TestFetchLatestVersion:
    ...
    @patch("coco_codes.version_checker.httpx.get")
...
class TestDefaultVersionMismatchBehavior:
    ...
    @patch("coco_codes.version_checker.get_message_bus")
    @patch("coco_codes.version_checker.emit_success")
    @patch("coco_codes.version_checker.emit_warning")
    @patch("coco_codes.version_checker.emit_info")
    @patch("coco_codes.version_checker.fetch_latest_version")
