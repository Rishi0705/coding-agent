"""Additional coverage tests for coding_agent.command_line.utils.
...
class TestResetWindowsConsole:
    ...
    def test_returns_early_on_non_windows(self):
        ...
        from coding_agent.command_line.utils import _reset_windows_console
...
class TestSafeInput:
    ...
    def test_calls_reset_windows_console(self):
        ...
        with patch(
            "coding_agent.command_line.utils._reset_windows_console"
        ) as mock_reset:
    ...
    def test_returns_stripped_input(self):
        ...
        with patch("coding_agent.command_line.utils._reset_windows_console"):
