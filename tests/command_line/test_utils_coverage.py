"""Additional coverage tests for coco_codes.command_line.utils.
...
class TestResetWindowsConsole:
    ...
    def test_returns_early_on_non_windows(self):
        ...
        from coco_codes.command_line.utils import _reset_windows_console
...
class TestSafeInput:
    ...
    def test_calls_reset_windows_console(self):
        ...
        with patch(
            "coco_codes.command_line.utils._reset_windows_console"
        ) as mock_reset:
    ...
    def test_returns_stripped_input(self):
        ...
        with patch("coco_codes.command_line.utils._reset_windows_console"):
