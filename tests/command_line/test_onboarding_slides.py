"""Tests for coding_agent/command_line/onboarding_slides.py"""

MODULE = "coding_agent.command_line.onboarding_slides"


class TestModelOptions:
    def test_model_options_is_list(self):
        from coding_agent.command_line.onboarding_slides import MODEL_OPTIONS
...
class TestGetNavFooter:
    def test_returns_string(self):
        from coding_agent.command_line.onboarding_slides import get_nav_footer
...
class TestGetGradientBanner:
    def test_with_pyfiglet(self):
        from coding_agent.command_line.onboarding_slides import get_gradient_banner
    ...
    def test_without_pyfiglet(self):
        ...
        import coding_agent.command_line.onboarding_slides as mod
...
class TestSlideWelcome:
    def test_returns_string(self):
        from coding_agent.command_line.onboarding_slides import slide_welcome
...
class TestSlideModels:
    def test_with_options(self):
        from coding_agent.command_line.onboarding_slides import slide_models
...
class TestSlideMcp:
    def test_returns_string(self):
        from coding_agent.command_line.onboarding_slides import slide_mcp
...
class TestSlideUseCases:
    def test_returns_string(self):
        from coding_agent.command_line.onboarding_slides import slide_use_cases
...
class TestSlideDone:
    def test_without_oauth(self):
        from coding_agent.command_line.onboarding_slides import slide_done
