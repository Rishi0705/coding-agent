...
class TestEnsurePluginsLoaded:
    def test_already_loaded(self):
        import coco_codes.command_line.command_handler as ch
    ...
    @patch("coco_codes.command_line.command_handler._PLUGINS_LOADED", False)
    ...
    @patch("coco_codes.command_line.command_handler._PLUGINS_LOADED", False)
    @patch("coco_codes.plugins.load_plugin_callbacks", side_effect=Exception("boom"))
    ...
    @patch("coco_codes.command_line.command_handler._PLUGINS_LOADED", False)
    @patch("coco_codes.plugins.load_plugin_callbacks", side_effect=Exception("boom"))
    @patch("coco_codes.messaging.emit_warning", side_effect=Exception("double boom"))
...
class TestGetCommandsHelp:
    @patch("coco_codes.command_line.command_handler._ensure_plugins_loaded")
    @patch("coco_codes.command_line.command_registry.get_unique_commands")
    ...
    def test_basic_help(self, mock_custom, mock_cmds, mock_plugins):
        ...
        from coco_codes.command_line.command_registry import CommandInfo
    ...
    @patch("coco_codes.command_line.command_handler._ensure_plugins_loaded")
    @patch(
        "coco_codes.command_line.command_registry.get_unique_commands", return_value=[]
    )
    @patch("coco_codes.callbacks.on_custom_command_help")
    ...
    @patch("coco_codes.callbacks.on_custom_command_help", side_effect=Exception("err"))
...
class TestHandleCommand:
    @patch("coco_codes.command_line.command_handler._ensure_plugins_loaded")
    @patch("coco_codes.command_line.command_registry.get_command")
    ...
    @patch("coco_codes.command_line.command_handler._ensure_plugins_loaded")
    @patch("coco_codes.command_line.command_registry.get_command", return_value=None)
    @patch("coco_codes.callbacks.on_custom_command", return_value=[True])
    ...
    @patch("coco_codes.command_line.command_handler._ensure_plugins_loaded")
    @patch("coco_codes.command_line.command_registry.get_command", return_value=None)
    @patch("coco_codes.callbacks.on_custom_command", return_value=["some text"])
    ...
    @patch("coco_codes.command_line.command_registry.get_command", return_value=None)
    @patch("coco_codes.callbacks.on_custom_command", return_value=["some text"])
    @patch("coco_codes.messaging.emit_info", side_effect=Exception("oops"))
    ...
    @patch("coco_codes.command_line.command_handler._ensure_plugins_loaded")
    @patch("coco_codes.command_line.command_registry.get_command", return_value=None)
    @patch("coco_codes.callbacks.on_custom_command", return_value=[None])
    @patch("coco_codes.messaging.emit_warning")
    ...
    @patch("coco_codes.command_line.command_registry.get_command", return_value=None)
    @patch(
        "coco_codes.callbacks.on_custom_command", side_effect=Exception("plugin err")
    )
    @patch("coco_codes.messaging.emit_warning")
    ...
    @patch("coco_codes.command_line.command_handler._ensure_plugins_loaded")
    @patch("coco_codes.command_line.command_registry.get_command", return_value=None)
    @patch("coco_codes.callbacks.on_custom_command")
    def test_markdown_command_result(self, mock_custom, mock_get, mock_plugins):
        ...
        with patch.dict(
            "sys.modules",
            {
                "coco_codes.plugins.customizable_commands.register_callbacks": MagicMock(
