...
class TestEnsurePluginsLoaded:
    def test_already_loaded(self):
        import coding_agent.command_line.command_handler as ch
    ...
    @patch("coding_agent.command_line.command_handler._PLUGINS_LOADED", False)
    ...
    @patch("coding_agent.command_line.command_handler._PLUGINS_LOADED", False)
    @patch("coding_agent.plugins.load_plugin_callbacks", side_effect=Exception("boom"))
    ...
    @patch("coding_agent.command_line.command_handler._PLUGINS_LOADED", False)
    @patch("coding_agent.plugins.load_plugin_callbacks", side_effect=Exception("boom"))
    @patch("coding_agent.messaging.emit_warning", side_effect=Exception("double boom"))
...
class TestGetCommandsHelp:
    @patch("coding_agent.command_line.command_handler._ensure_plugins_loaded")
    @patch("coding_agent.command_line.command_registry.get_unique_commands")
    ...
    def test_basic_help(self, mock_custom, mock_cmds, mock_plugins):
        ...
        from coding_agent.command_line.command_registry import CommandInfo
    ...
    @patch("coding_agent.command_line.command_handler._ensure_plugins_loaded")
    @patch(
        "coding_agent.command_line.command_registry.get_unique_commands", return_value=[]
    )
    @patch("coding_agent.callbacks.on_custom_command_help")
    ...
    @patch("coding_agent.callbacks.on_custom_command_help", side_effect=Exception("err"))
...
class TestHandleCommand:
    @patch("coding_agent.command_line.command_handler._ensure_plugins_loaded")
    @patch("coding_agent.command_line.command_registry.get_command")
    ...
    @patch("coding_agent.command_line.command_handler._ensure_plugins_loaded")
    @patch("coding_agent.command_line.command_registry.get_command", return_value=None)
    @patch("coding_agent.callbacks.on_custom_command", return_value=[True])
    ...
    @patch("coding_agent.command_line.command_handler._ensure_plugins_loaded")
    @patch("coding_agent.command_line.command_registry.get_command", return_value=None)
    @patch("coding_agent.callbacks.on_custom_command", return_value=["some text"])
    ...
    @patch("coding_agent.command_line.command_registry.get_command", return_value=None)
    @patch("coding_agent.callbacks.on_custom_command", return_value=["some text"])
    @patch("coding_agent.messaging.emit_info", side_effect=Exception("oops"))
    ...
    @patch("coding_agent.command_line.command_handler._ensure_plugins_loaded")
    @patch("coding_agent.command_line.command_registry.get_command", return_value=None)
    @patch("coding_agent.callbacks.on_custom_command", return_value=[None])
    @patch("coding_agent.messaging.emit_warning")
    ...
    @patch("coding_agent.command_line.command_registry.get_command", return_value=None)
    @patch(
        "coding_agent.callbacks.on_custom_command", side_effect=Exception("plugin err")
    )
    @patch("coding_agent.messaging.emit_warning")
    ...
    @patch("coding_agent.command_line.command_handler._ensure_plugins_loaded")
    @patch("coding_agent.command_line.command_registry.get_command", return_value=None)
    @patch("coding_agent.callbacks.on_custom_command")
    def test_markdown_command_result(self, mock_custom, mock_get, mock_plugins):
        ...
        with patch.dict(
            "sys.modules",
            {
                "coding_agent.plugins.customizable_commands.register_callbacks": MagicMock(
