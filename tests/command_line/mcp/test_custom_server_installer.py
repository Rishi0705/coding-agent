"""Tests for coco_codes/command_line/mcp/custom_server_installer.py"""

import json
from unittest.mock import MagicMock, patch

MODULE = "coco_codes.command_line.mcp.custom_server_installer"
...
class TestPromptAndInstallCustomServer:
    ...
    def test_empty_name_returns_false(self, mock_warn, mock_input):
        from coco_codes.command_line.mcp.custom_server_installer import (
