"""Tests for coding_agent/command_line/mcp/custom_server_installer.py"""

import json
from unittest.mock import MagicMock, patch

MODULE = "coding_agent.command_line.mcp.custom_server_installer"
...
class TestPromptAndInstallCustomServer:
    ...
    def test_empty_name_returns_false(self, mock_warn, mock_input):
        from coding_agent.command_line.mcp.custom_server_installer import (
