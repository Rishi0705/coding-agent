...
class TestGetSessionEntries:
    ...
    @patch("coco_codes.command_line.autosave_menu.list_sessions")
    @patch("coco_codes.command_line.autosave_menu._get_session_metadata")
...
class TestRenderPreviewPanel:
    ...
    @patch("coco_codes.command_line.autosave_menu.load_session")
    @patch("coco_codes.command_line.autosave_menu._extract_last_user_message")
...
class TestInteractiveAutosavePicker:
    ...
    @patch("coco_codes.command_line.autosave_menu._get_session_entries")
    ...
    @patch("coco_codes.command_line.autosave_menu._get_session_entries")
    @patch("coco_codes.command_line.autosave_menu._render_menu_panel")
    @patch("coco_codes.command_line.autosave_menu._render_preview_panel")
    ...
    async def test_application_setup_and_cleanup(
        ...
        with patch("coco_codes.command_line.autosave_menu.Application") as mock_app:
    ...
    async def test_navigation_key_bindings(
        ...
        with patch("coco_codes.command_line.autosave_menu.Application") as mock_app:
            ...
            with patch(
                "coco_codes.command_line.autosave_menu.Application",
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_with_nonexistent_autosave_dir(self):
        ...
        with patch(
            "coco_codes.command_line.autosave_menu.AUTOSAVE_DIR", "/nonexistent/path"
        ):
            with patch(
                "coco_codes.command_line.autosave_menu.list_sessions",
    ...
    def test_with_permission_denied_access(self):
        ...
        with patch(
            "coco_codes.command_line.autosave_menu._get_session_metadata",
...
class TestDisplayResumedHistory:
    ...
    def test_empty_history_returns_early(self):
        ...
        from coco_codes.command_line.autosave_menu import display_resumed_history
