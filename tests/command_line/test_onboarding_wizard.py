"""Tests for coco_codes/command_line/onboarding_wizard.py"""
...
MODULE = "coco_codes.command_line.onboarding_wizard"
...
class TestHasCompletedOnboarding:
    ...
    def test_returns_true_when_file_exists(self, mock_exists):
        from coco_codes.command_line.onboarding_wizard import has_completed_onboarding
...
class TestMarkOnboardingComplete:
    ...
    def test_creates_file(self, m_open, m_makedirs):
        from coco_codes.command_line.onboarding_wizard import mark_onboarding_complete
...
class TestResetOnboarding:
    ...
    def test_removes_file(self, mock_remove, mock_exists):
        from coco_codes.command_line.onboarding_wizard import reset_onboarding
...
class TestOnboardingWizard:
    def _make_wizard(self):
        from coco_codes.command_line.onboarding_wizard import OnboardingWizard
...
class TestRunOnboardingIfNeeded:
    ...
    async def test_skips_if_not_needed(self, mock_should):
        from coco_codes.command_line.onboarding_wizard import run_onboarding_if_needed
