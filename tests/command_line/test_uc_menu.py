...
from coding_agent.command_line.uc_menu import (
    PAGE_SIZE,
    _get_tool_entries,
    _render_menu_panel,
...
class TestGetToolEntries:
    ...
    def test_empty_registry(self):
        ...
        with patch(
            "coding_agent.command_line.uc_menu.get_registry",
...
class TestToggleToolEnabled:
    ...
    def test_toggle_enabled_to_disabled(self):
        ...
        try:
            ...
            with patch("coding_agent.command_line.uc_menu.emit_success"):
...
class TestShowSourceCode:
    ...
    def test_shows_source_code(self):
        ...
        try:
            ...
            with patch("coding_agent.command_line.uc_menu.emit_info") as mock_emit:
    ...
    def test_handles_read_error(self, mock_tool_enabled):
        ...
        with patch("coding_agent.command_line.uc_menu.emit_error") as mock_error:
...
class TestHandleUcCommand:
    ...
    def test_launches_tui(self):
        ...
        with patch(
            "coding_agent.command_line.uc_menu.interactive_uc_picker",
...
class TestInteractiveUcPicker:
    ...
    async def test_returns_none_when_cancelled(self):
        ...
        with patch(
            "coding_agent.command_line.uc_menu._get_tool_entries",
            return_value=[],
        ):
            with patch(
                "coding_agent.command_line.uc_menu.Application",
                return_value=mock_app,
            ):
                with patch("coding_agent.command_line.uc_menu.set_awaiting_user_input"):
...
class TestPageSize:
    ...
    def test_source_page_size_exists(self):
        ...
        from coding_agent.command_line.uc_menu import SOURCE_PAGE_SIZE
