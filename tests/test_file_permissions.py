...
class TestFilePermissions(unittest.TestCase):
    ...
    @patch("coding_agent.callbacks.on_file_permission")
    ...
    @patch("coding_agent.config.get_yolo_mode")
    ...
    @patch("coding_agent.tools.file_modifications.emit_success")
    @patch("coding_agent.tools.file_modifications._emit_diff_message")
    @patch("coding_agent.callbacks.on_file_permission")
