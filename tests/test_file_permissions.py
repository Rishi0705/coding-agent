...
class TestFilePermissions(unittest.TestCase):
    ...
    @patch("coco_codes.callbacks.on_file_permission")
    ...
    @patch("coco_codes.config.get_yolo_mode")
    ...
    @patch("coco_codes.tools.file_modifications.emit_success")
    @patch("coco_codes.tools.file_modifications._emit_diff_message")
    @patch("coco_codes.callbacks.on_file_permission")
