...
# ============================================================
from coding_agent.plugins.shell_safety.command_cache import (
    CachedAssessment,
    CommandSafetyCache,
    cache_assessment,
    get_cache_stats,
...
class TestShellSafetyAgent:
    ...
    def test_agent_properties(self):
        ...
        with patch.dict(
            "sys.modules",
            {
                "coding_agent.agents.base_agent": mock_base,
                "coding_agent.agents": MagicMock(),
            },
        ):
            # Force reimport
            import importlib

            import coding_agent.plugins.shell_safety.agent_shell_safety as mod
...
from coding_agent.plugins.shell_safety.register_callbacks import (  # noqa: E402
    is_oauth_model,
)
...
from coding_agent.plugins.agent_skills.discovery import discover_skills  # noqa: E402
...
from coding_agent.plugins.agent_skills.metadata import (  # noqa: E402
    get_skill_resources,
...
from coding_agent.plugins.agent_skills.skill_catalog import (  # noqa: E402
    SkillCatalog,
...
class TestSkillCatalogMissing:
    ...
    def test_catalog_init_remote_exception(self):
        ...
        with patch(
            "coding_agent.plugins.agent_skills.skill_catalog.fetch_remote_catalog",
...
class TestSkillsInstallMenuSizeFormat:
    def test_format_size_gb(self):
        ...
        from coding_agent.plugins.agent_skills.skills_install_menu import _format_bytes
...
from coding_agent.plugins.universal_constructor.registry import UCRegistry  # noqa: E402
...
"""
        ...
        with patch(
            "coding_agent.plugins.universal_constructor.registry.inspect.signature",
...
from coding_agent.plugins.universal_constructor.sandbox import (  # noqa: E402
    FunctionInfo,
    _extract_tool_meta,
    _find_main_function,
    _get_call_name,
