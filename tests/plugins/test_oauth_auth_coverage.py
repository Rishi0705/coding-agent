...
class TestClaudeCodeConfigPaths:
    @patch("coding_agent.plugins.claude_code_oauth.config.config")
...
class TestChatgptTestPlugin:
    ...
    def test_config_paths(self):
        from coding_agent.plugins.chatgpt_oauth.test_plugin import test_config_paths

        test_config_paths()

    def test_oauth_config(self):
        from coding_agent.plugins.chatgpt_oauth.test_plugin import test_oauth_config

        test_oauth_config()

    def test_jwt_parsing_with_nested_org(self):
        from coding_agent.plugins.chatgpt_oauth.test_plugin import (
    ...
    def test_parse_jwt_claims(self):
        from coding_agent.plugins.chatgpt_oauth.test_plugin import test_parse_jwt_claims
    ...
    def test_exchange_code_for_tokens(self):
        ...
        from coding_agent.plugins.chatgpt_oauth import test_plugin
...
class TestClaudeCodeTestPlugin:
    ...
    def test_plugin_imports(self):
        from coding_agent.plugins.claude_code_oauth.test_plugin import (
            test_plugin_imports,
        )
    ...
    def test_main_all_pass(self):
        from coding_agent.plugins.claude_code_oauth.test_plugin import main
