...
class TestTokenExchange:
    ...
    @patch("coco_codes.plugins.claude_code_oauth.utils.requests.post")
...
class TestTokenRefresh:
    ...
    @patch("coco_codes.plugins.claude_code_oauth.utils.requests.post")
    @patch("coco_codes.plugins.claude_code_oauth.utils.load_stored_tokens")
    @patch("coco_codes.plugins.claude_code_oauth.utils.save_tokens")
    ...
    def test_refresh_access_token_forced_refresh(self, mock_load, sample_token_data):
        ...
        with patch(
            "coco_codes.plugins.claude_code_oauth.utils.requests.post"
        ) as mock_post:
...
class TestValidAccessToken:
    ...
    @patch("coco_codes.plugins.claude_code_oauth.utils.refresh_access_token")
    @patch("coco_codes.plugins.claude_code_oauth.utils.load_stored_tokens")
