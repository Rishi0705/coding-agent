...
class TestTokenExchange:
    ...
    @patch("coding_agent.plugins.claude_code_oauth.utils.requests.post")
...
class TestTokenRefresh:
    ...
    @patch("coding_agent.plugins.claude_code_oauth.utils.requests.post")
    @patch("coding_agent.plugins.claude_code_oauth.utils.load_stored_tokens")
    @patch("coding_agent.plugins.claude_code_oauth.utils.save_tokens")
    ...
    def test_refresh_access_token_forced_refresh(self, mock_load, sample_token_data):
        ...
        with patch(
            "coding_agent.plugins.claude_code_oauth.utils.requests.post"
        ) as mock_post:
...
class TestValidAccessToken:
    ...
    @patch("coding_agent.plugins.claude_code_oauth.utils.refresh_access_token")
    @patch("coding_agent.plugins.claude_code_oauth.utils.load_stored_tokens")
