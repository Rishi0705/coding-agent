...
class TestTokenRefresh:
    ...
    @patch("coco_codes.plugins.chatgpt_oauth.utils.load_stored_tokens")
    ...
    @patch("coco_codes.plugins.chatgpt_oauth.utils.refresh_access_token")
    @patch("coco_codes.plugins.chatgpt_oauth.utils.load_stored_tokens")
    ...
    @patch("coco_codes.plugins.chatgpt_oauth.utils.save_tokens")
    @patch("requests.post")
    @patch("coco_codes.plugins.chatgpt_oauth.utils.load_stored_tokens")
