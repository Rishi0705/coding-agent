...
class TestTokenRefresh:
    ...
    @patch("coding_agent.plugins.chatgpt_oauth.utils.load_stored_tokens")
    ...
    @patch("coding_agent.plugins.chatgpt_oauth.utils.refresh_access_token")
    @patch("coding_agent.plugins.chatgpt_oauth.utils.load_stored_tokens")
    ...
    @patch("coding_agent.plugins.chatgpt_oauth.utils.save_tokens")
    @patch("requests.post")
    @patch("coding_agent.plugins.chatgpt_oauth.utils.load_stored_tokens")
