"""Tests for coco_codes/messaging/spinner/__init__.py module.
...
from coco_codes.messaging.spinner import (
    _active_spinners,
...
class TestPauseAllSpinners:
    ...
    @patch("coco_codes.tools.subagent_context.is_subagent", return_value=False)
    ...
    @patch("coco_codes.tools.subagent_context.is_subagent", return_value=True)
