"""Tests for coding_agent/messaging/spinner/__init__.py module.
...
from coding_agent.messaging.spinner import (
    _active_spinners,
...
class TestPauseAllSpinners:
    ...
    @patch("coding_agent.tools.subagent_context.is_subagent", return_value=False)
    ...
    @patch("coding_agent.tools.subagent_context.is_subagent", return_value=True)
