...
from coding_agent.http_utils import ProxyConfig
...
class TestResolveProxyConfig:
    ...
    @patch("coding_agent.http_utils.get_cert_bundle_path")
    @patch("coding_agent.http_utils.get_http2")
...
class TestCreateAsyncClient:
    ...
    @patch("coding_agent.http_utils._resolve_proxy_config")
    def test_create_async_client_basic(
        self,
        mock_resolve_proxy,
    ):
        """Test basic async client creation."""
        from coding_agent.http_utils import create_async_client
