...
from coco_codes.http_utils import ProxyConfig
...
class TestResolveProxyConfig:
    ...
    @patch("coco_codes.http_utils.get_cert_bundle_path")
    @patch("coco_codes.http_utils.get_http2")
...
class TestCreateAsyncClient:
    ...
    @patch("coco_codes.http_utils._resolve_proxy_config")
    def test_create_async_client_basic(
        self,
        mock_resolve_proxy,
    ):
        """Test basic async client creation."""
        from coco_codes.http_utils import create_async_client
