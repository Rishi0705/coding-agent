...
from coding_agent.uvx_detection import (
...
class TestIsLaunchedViaUVX:
    ...
    @patch("coding_agent.uvx_detection._get_parent_process_chain")
...
class TestShouldUseAlternateCancelKey:
    ...
    @patch("coding_agent.uvx_detection.is_windows")
    @patch("coding_agent.uvx_detection.is_launched_via_uvx")
...
class TestGetParentProcessChainWindowsCtypes:
    ...
    @patch("platform.system")
    @patch("coding_agent.uvx_detection.os.getpid")
...
class TestGetParentProcessChain:
    ...
    @patch("coding_agent.uvx_detection._get_parent_process_chain_psutil")
    ...
    @patch("coding_agent.uvx_detection._get_parent_process_chain_windows_ctypes")
    @patch("platform.system")
