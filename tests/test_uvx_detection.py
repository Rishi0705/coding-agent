...
from coco_codes.uvx_detection import (
...
class TestIsLaunchedViaUVX:
    ...
    @patch("coco_codes.uvx_detection._get_parent_process_chain")
...
class TestShouldUseAlternateCancelKey:
    ...
    @patch("coco_codes.uvx_detection.is_windows")
    @patch("coco_codes.uvx_detection.is_launched_via_uvx")
...
class TestGetParentProcessChainWindowsCtypes:
    ...
    @patch("platform.system")
    @patch("coco_codes.uvx_detection.os.getpid")
...
class TestGetParentProcessChain:
    ...
    @patch("coco_codes.uvx_detection._get_parent_process_chain_psutil")
    ...
    @patch("coco_codes.uvx_detection._get_parent_process_chain_windows_ctypes")
    @patch("platform.system")
