...
def test_version_smoke() -> None:
    child = pexpect.spawn("coding-agent --version", encoding="utf-8")
...
def test_help_smoke() -> None:
    child = pexpect.spawn("coding-agent --help", encoding="utf-8")
...
def test_interactive_smoke() -> None:
    ...
    """
    child = pexpect.spawn("coding-agent -i", encoding="utf-8")
