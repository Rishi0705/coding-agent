...
def test_version_smoke() -> None:
    child = pexpect.spawn("coco-codes --version", encoding="utf-8")
...
def test_help_smoke() -> None:
    child = pexpect.spawn("coco-codes --help", encoding="utf-8")
...
def test_interactive_smoke() -> None:
    ...
    """
    child = pexpect.spawn("coco-codes -i", encoding="utf-8")
