...
def test_set_completer_no_match(monkeypatch):
    monkeypatch.setattr("coco_codes.config.get_config_keys", lambda: ["actual_key"])
    completer = SetCompleter()
...
@pytest.mark.asyncio
@patch("coco_codes.command_line.prompt_toolkit_completion.PromptSession")
@patch("coco_codes.command_line.prompt_toolkit_completion.FileHistory")
@patch("coco_codes.command_line.prompt_toolkit_completion.merge_completers")
...
@pytest.mark.asyncio
@patch("coco_codes.command_line.prompt_toolkit_completion.PromptSession")
@patch("coco_codes.command_line.prompt_toolkit_completion.SafeFileHistory")
