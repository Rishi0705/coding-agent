...
from coding_agent.session_storage import SessionMetadata


@pytest.fixture
def mock_config_paths(monkeypatch):
    mock_home = "/mock_home"
    mock_config_dir = os.path.join(mock_home, ".coding_agent")
...
class TestAutoSaveSessionFunctionality:
    @patch("coding_agent.config.get_auto_save_session")
    ...
    @patch("coding_agent.config.save_session")
    @patch("coding_agent.config.get_current_autosave_session_name")
    @patch("coding_agent.config.datetime.datetime")
    @patch("coding_agent.config.get_auto_save_session")
...
class TestFinalizeAutoSaveSession:
    @patch("coding_agent.config.rotate_autosave_id", return_value="fresh_id")
    @patch("coding_agent.config.auto_save_session_if_enabled", return_value=True)
    ...
    @patch("coding_agent.config.rotate_autosave_id", return_value="fresh_id")
    @patch("coding_agent.config.auto_save_session_if_enabled", return_value=False)
